...
#define _CFFI_PYTHON_STARTUP_CODE  "from my_library import ffi, lib\n" \
"\n" \
"@ffi.def_extern()\n" \
...
static struct _cffi_externpy_s _cffi_externpy__compute_num =
  { "compute_num", (int)sizeof(int) };

CFFI_DLLEXPORT int compute_num(int a0, int a1)
{
  char a[16];
  char *p = a;
  *(int *)(p + 0) = a0;
  *(int *)(p + 8) = a1;
  _cffi_call_python(&_cffi_externpy__compute_num, p);
  return *(int *)p;
}

static const struct _cffi_global_s _cffi_globals[] = {
  { "compute_num", (void *)&_cffi_externpy__compute_num, _CFFI_OP(_CFFI_OP_EXTERN_PYTHON, 4), (void *)compute_num },
};
