...
mesapy: miniz_oxide
	cd pypy/goal && $(RUNINTERP) ../../rpython/bin/rpython -Ojit --make-jobs=$(shell nproc) --output=mesapy --no-shared targetpypystandalone.py --withoutmod-_cffi_backend --withoutmod-_rawffi --withoutmod-_cppyy
