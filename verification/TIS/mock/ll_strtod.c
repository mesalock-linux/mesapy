...
int main(void) {
    ...
    tis_make_unknown(y, sizeof y);
    tis_make_unknown(z, sizeof z);
    int p = tis_int_interval(-2147483648,2147483647);
    char code = tis_char_interval(0,127);
    double k = tis_double_interval(1.7976931348623158e-308, 1.7976931348623158e+308);
    LL_strtod_formatd(k, code, p);
    LL_strtod_parts_to_float(x, y, z, m);
}
