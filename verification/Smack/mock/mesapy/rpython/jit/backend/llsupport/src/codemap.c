...
int main(void){
    unsigned long addr = __VERIFIER_nondet_unsigned_long();
    unsigned int machine_code_size = __VERIFIER_nondet_unsigned_int();
    long bi = __VERIFIER_nondet_long();
    long *bytecode_info = &bi;
    unsigned int bytecode_info_size = __VERIFIER_nondet_unsigned_int();
