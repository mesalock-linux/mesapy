...
libname = 'mesalink'
ROOT = rpythonroot + '/lib_rust/mesalink'
includes = [
    'mesalink/openssl/ssl.h',
    'mesalink/openssl/err.h']
...
SSL_ERROR_NONE = rffi_platform.ConstantInteger("SSL_ERROR_NONE")
SSL_FAILURE = rffi_platform.ConstantInteger("SSL_FAILURE")
SSL_FATAL_ERROR = rffi_platform.ConstantInteger("SSL_FATAL_ERROR")
SSL_SUCCESS = rffi_platform.ConstantInteger("SSL_SUCCESS")
SSL_SHUTDOWN_NOT_DONE = rffi_platform.ConstantInteger("SSL_SHUTDOWN_NOT_DONE")
SSL_ERROR_WANT_READ = rffi_platform.ConstantInteger("SSL_ERROR_WANT_READ")
SSL_ERROR_WANT_WRITE = rffi_platform.ConstantInteger("SSL_ERROR_WANT_WRITE")
SSL_ERROR_WANT_CONNECT = rffi_platform.ConstantInteger("SSL_ERROR_WANT_CONNECT")
SSL_ERROR_WANT_ACCEPT = rffi_platform.ConstantInteger("SSL_ERROR_WANT_ACCEPT")
SSL_ERROR_ZERO_RETURN = rffi_platform.ConstantInteger("SSL_ERROR_ZERO_RETURN")
...
SSL_FILETYPE_DEFAULT = rffi_platform.ConstantInteger("SSL_FILETYPE_DEFAULT")
SSL_FILETYPE_RAW = rffi_platform.ConstantInteger("SSL_FILETYPE_RAW")
...
def ssl_external(name, argtypes, restype, **kw):
    globals()['mesalink_' + name] = external(
        name, argtypes, restype, **kw)
